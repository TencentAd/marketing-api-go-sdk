...
type DynamicCreativesUpdateExample struct {
	TAds        *ads.SDKClient
	AccessToken string
	Data        model.DynamicCreativesUpdateRequest
}

func (e *DynamicCreativesUpdateExample) Init() {
...
func (e *DynamicCreativesUpdateExample) RunExample() (interface{}, *http.Response, error) {
	tads := e.TAds
	// change ctx as needed
	ctx := *tads.Ctx
	return tads.DynamicCreatives().Update(ctx, e.Data)
}
