...
type MaterialLabelsUpdateExample struct {
	TAds        *ads.SDKClient
	AccessToken string
	Data        model.MaterialLabelsUpdateRequest
}

func (e *MaterialLabelsUpdateExample) Init() {
...
func (e *MaterialLabelsUpdateExample) RunExample() (interface{}, http.Header, error) {
	...
	ctx := *tads.Ctx
	return tads.MaterialLabels().Update(ctx, e.Data)
}

func main() {
	e := &MaterialLabelsUpdateExample{}
	e.Init()
