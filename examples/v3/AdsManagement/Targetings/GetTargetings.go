...
type TargetingsGetExample struct {
	TAds        *ads.SDKClient
	AccessToken string
	Data        model.TargetingsGetRequest
}
...
func (e *TargetingsGetExample) Init() {
	...
	e.Data = model.TargetingsGetRequest{
		AccountId: int64(0),
	}
}

func (e *TargetingsGetExample) RunExample() (model.TargetingsGetResponseData, http.Header, error) {
	tads := e.TAds
	// change ctx as needed
	ctx := *tads.Ctx
	return tads.Targetings().Get(ctx, e.Data)
}
