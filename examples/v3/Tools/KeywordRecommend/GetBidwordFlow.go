...
type BidwordFlowGetExample struct {
	...
	AccountId          int64
	BidwordList        []string
	BidwordFlowGetOpts *api.BidwordFlowGetOpts
}
...
func (e *BidwordFlowGetExample) Init() {
	...
	e.AccountId = 789
	e.BidwordList = []string{}
	e.BidwordFlowGetOpts = &api.BidwordFlowGetOpts{}
}
...
func (e *BidwordFlowGetExample) RunExample() (model.BidwordFlowGetResponseData, http.Header, error) {
	...
	ctx := *tads.Ctx
	return tads.BidwordFlow().Get(ctx, e.AccountId, e.BidwordList, e.BidwordFlowGetOpts)
}
