...
type AdvertiserConfigGetExample struct {
	TAds                    *ads.SDKClient
	AccessToken             string
	AccountId               int64
	Fields                  []string
...
func (e *AdvertiserConfigGetExample) Init() {
...
func (e *AdvertiserConfigGetExample) RunExample() (model.AdvertiserConfigGetResponseData, http.Header, error) {
	tads := e.TAds
