...
type FundTransferAddExample struct {
	TAds        *ads.SDKClient
	AccessToken string
	Data        model.FundTransferAddRequest
}

func (e *FundTransferAddExample) Init() {
...
func (e *FundTransferAddExample) RunExample() (model.FundTransferAddResponseData, http.Header, error) {
	tads := e.TAds
	// change ctx as needed
	ctx := *tads.Ctx
	return tads.FundTransfer().Add(ctx, e.Data)
}

func main() {
	e := &FundTransferAddExample{}
	e.Init()
