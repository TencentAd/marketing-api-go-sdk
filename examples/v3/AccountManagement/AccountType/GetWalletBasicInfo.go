...
type WalletBasicInfoGetExample struct {
	TAds                   *ads.SDKClient
	AccessToken            string
	AccountId              int64
	WalletId               int64
...
func (e *WalletBasicInfoGetExample) Init() {
...
func (e *WalletBasicInfoGetExample) RunExample() (model.WalletBasicInfoGetResponseData, http.Header, error) {
	tads := e.TAds
