...
func (e *AgencyRealtimeCostGetExample) Init() {
...
func (e *AgencyRealtimeCostGetExample) RunExample() (model.AgencyRealtimeCostGetResponseData, http.Header, error) {
	tads := e.TAds
...
func main() {
	e := &AgencyRealtimeCostGetExample{}
	e.Init()
