...
func (e *MergeFundTypeFundsGetExample) Init() {
...
func (e *MergeFundTypeFundsGetExample) RunExample() (model.MergeFundTypeFundsGetResponseData, http.Header, error) {
	tads := e.TAds
...
func main() {
	e := &MergeFundTypeFundsGetExample{}
	e.Init()
