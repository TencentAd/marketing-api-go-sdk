...
type DailyReportsGetListStruct struct {
	...
	DeepLinkCnt                         int64   `json:"deep_link_cnt,omitempty"`
	AppApplicationRate                  float64 `json:"app_application_rate,omitempty"`
	WebApplicationRate                  float64 `json:"web_application_rate,omitempty"`
	AppArousedRate                      float64 `json:"app_aroused_rate,omitempty"`
	AppArousedCost                      int64   `json:"app_aroused_cost,omitempty"`
