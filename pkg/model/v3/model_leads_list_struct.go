...
type LeadsListStruct struct {
	...
	LeadsIpLocation          *string        `json:"leads_ip_location,omitempty"`
	FinderNickName           *string        `json:"finder_nick_name,omitempty"`
	FanStatus                *int64         `json:"fan_status,omitempty"`
	StaffName                *string        `json:"staff_name,omitempty"`
	CommonPageId             *string        `json:"common_page_id,omitempty"`
}
