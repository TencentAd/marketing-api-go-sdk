...
/*
WechatAdvertiserDetailApiService 【待废弃，请使用新接口wechat_advertiser_specification/get】查询微信公众平台广告主详情信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WechatAdvertiserDetailGetOpts - Optional Parameters:
...
func (a *WechatAdvertiserDetailApiService) Get(ctx context.Context, localVarOptionals *WechatAdvertiserDetailGetOpts) (WechatAdvertiserDetailGetResponseData, *http.Response, error) {
	var (
		...
		localVarReturnValue WechatAdvertiserDetailGetResponseData
		localVarResponse    WechatAdvertiserDetailGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_advertiser_detail/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatAdvertiserDetailGetResponse
