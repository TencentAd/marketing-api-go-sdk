...
func (a *LeadsApiService) Get(ctx context.Context, accountId int64, timeRange TimeRange, positionType string, localVarOptionals *LeadsGetOpts) (LeadsGetResponseData, http.Header, error) {
	var (
