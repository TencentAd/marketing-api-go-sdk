...
func (a *TargetingsShareApiService) Add(ctx context.Context, data TargetingsShareAddRequest) (TargetingsShareAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue TargetingsShareAddResponseData
		localVarResponse    TargetingsShareAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/targetings_share/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v TargetingsShareAddResponse
...
/*
TargetingsShareApiService 获取定向分享记录
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param targetingId
 * @param optional nil or *TargetingsShareGetOpts - Optional Parameters:
...
func (a *TargetingsShareApiService) Get(ctx context.Context, accountId int64, targetingId int64, localVarOptionals *TargetingsShareGetOpts) (TargetingsShareGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue TargetingsShareGetResponseData
		localVarResponse    TargetingsShareGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/targetings_share/get"
	...
	localVarQueryParams.Add("targeting_id", parameterToString(targetingId, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v TargetingsShareGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
