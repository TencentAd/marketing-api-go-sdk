...
/*
WeixinOfficialAccountsUpgradeStatusApiService 获取微信公众号账户升级状态
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *WeixinOfficialAccountsUpgradeStatusGetOpts - Optional Parameters:
...
func (a *WeixinOfficialAccountsUpgradeStatusApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WeixinOfficialAccountsUpgradeStatusGetOpts) (WeixinOfficialAccountsUpgradeStatusGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WeixinOfficialAccountsUpgradeStatusGetResponseData
		localVarResponse    WeixinOfficialAccountsUpgradeStatusGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/weixin_official_accounts_upgrade_status/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WeixinOfficialAccountsUpgradeStatusGetResponse
