...
/*
DailyCostApiService 【待废弃，请使用新接口wechat_daily_cost/get】获取微信账户实时消耗
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dateRange
 * @param optional nil or *DailyCostGetOpts - Optional Parameters:
...
func (a *DailyCostApiService) Get(ctx context.Context, dateRange ReportDateRange, localVarOptionals *DailyCostGetOpts) (DailyCostGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DailyCostGetResponseData
		localVarResponse    DailyCostGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/daily_cost/get"
