...
func (a *OuterCluesContactApiService) Update(ctx context.Context, data OuterCluesContactUpdateRequest) (OuterCluesContactUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue OuterCluesContactUpdateResponseData
		localVarResponse    OuterCluesContactUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/outer_clues_contact/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OuterCluesContactUpdateResponse
