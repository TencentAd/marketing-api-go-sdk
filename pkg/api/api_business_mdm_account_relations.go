...
/*
BusinessMdmAccountRelationsApiService 查询商务管家或同主体下广告主信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param relationType
 * @param optional nil or *BusinessMdmAccountRelationsGetOpts - Optional Parameters:
...
func (a *BusinessMdmAccountRelationsApiService) Get(ctx context.Context, accountId int64, relationType string, localVarOptionals *BusinessMdmAccountRelationsGetOpts) (BusinessMdmAccountRelationsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BusinessMdmAccountRelationsGetResponseData
		localVarResponse    BusinessMdmAccountRelationsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/business_mdm_account_relations/get"
	...
	localVarQueryParams.Add("relation_type", parameterToString(relationType, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BusinessMdmAccountRelationsGetResponse
