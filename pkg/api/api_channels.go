...
func (a *ChannelsApiService) Add(ctx context.Context, data ChannelsAddRequest) (ChannelsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ChannelsAddResponseData
		localVarResponse    ChannelsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels/add"
...
/*
ChannelsApiService 删除广告
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return ChannelsDeleteResponse
*/
func (a *ChannelsApiService) Delete(ctx context.Context, data ChannelsDeleteRequest) (ChannelsDeleteResponseData, http.Header, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ChannelsDeleteResponseData
		localVarResponse    ChannelsDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels/delete"
...
func (a *ChannelsApiService) Get(ctx context.Context, data ChannelsGetRequest) (ChannelsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ChannelsGetResponseData
		localVarResponse    ChannelsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels/get"
...
func (a *ChannelsApiService) Update(ctx context.Context, data ChannelsUpdateRequest) (ChannelsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ChannelsUpdateResponseData
		localVarResponse    ChannelsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels/update"
