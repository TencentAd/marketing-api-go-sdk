...
/*
WechatDailyCostApiService 获取微信账户实时消耗
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dateRange
 * @param optional nil or *WechatDailyCostGetOpts - Optional Parameters:
...
func (a *WechatDailyCostApiService) Get(ctx context.Context, dateRange DateRange, localVarOptionals *WechatDailyCostGetOpts) (WechatDailyCostGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue WechatDailyCostGetResponseData
		localVarResponse    WechatDailyCostGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_daily_cost/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatDailyCostGetResponse
