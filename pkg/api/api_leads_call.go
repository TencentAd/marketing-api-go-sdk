...
func (a *LeadsCallApiService) Create(ctx context.Context, data LeadsCallCreateRequest) (LeadsCallCreateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsCallCreateResponseData
		localVarResponse    LeadsCallCreateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_call/create"
