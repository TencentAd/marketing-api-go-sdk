...
type SeedElementQuotaApiService service

/*
SeedElementQuotaApiService 获取素材库预审配额
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return SeedElementQuotaGetResponse
*/
func (a *SeedElementQuotaApiService) Get(ctx context.Context, data SeedElementQuotaGetRequest) (SeedElementQuotaGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue SeedElementQuotaGetResponseData
		localVarResponse    SeedElementQuotaGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/seed_element_quota/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SeedElementQuotaGetResponse
