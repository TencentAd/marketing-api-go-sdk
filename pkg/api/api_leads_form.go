...
func (a *LeadsFormApiService) Add(ctx context.Context, data LeadsFormAddRequest) (LeadsFormAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsFormAddResponseData
		localVarResponse    LeadsFormAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_form/add"
...
/*
LeadsFormApiService 获取表单组件详情
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param componentId
 * @param optional nil or *LeadsFormGetOpts - Optional Parameters:
...
func (a *LeadsFormApiService) Get(ctx context.Context, accountId int64, componentId string, localVarOptionals *LeadsFormGetOpts) (LeadsFormGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LeadsFormGetResponseData
		localVarResponse    LeadsFormGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_form/get"
