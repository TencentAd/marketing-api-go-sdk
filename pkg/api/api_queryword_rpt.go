...
func (a *QuerywordRptApiService) Get(ctx context.Context, data QuerywordRptGetRequest) (QuerywordRptGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue QuerywordRptGetResponseData
		localVarResponse    QuerywordRptGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/queryword_rpt/get"
