...
/*
WechatAdvertiserSpecificationApiService 查询微信公众平台广告主详情信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WechatAdvertiserSpecificationGetOpts - Optional Parameters:
...
func (a *WechatAdvertiserSpecificationApiService) Get(ctx context.Context, localVarOptionals *WechatAdvertiserSpecificationGetOpts) (WechatAdvertiserSpecificationGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue WechatAdvertiserSpecificationGetResponseData
		localVarResponse    WechatAdvertiserSpecificationGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_advertiser_specification/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatAdvertiserSpecificationGetResponse
