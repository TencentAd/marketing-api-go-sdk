...
/*
LeadsFormListApiService 获取表单组件列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *LeadsFormListGetOpts - Optional Parameters:
     * @param "BeginCreatedTime" (optional.String) -
     * @param "EndCreatedTime" (optional.String) -
...
func (a *LeadsFormListApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LeadsFormListGetOpts) (LeadsFormListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsFormListGetResponseData
		localVarResponse    LeadsFormListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_form_list/get"
	...
	if localVarOptionals != nil && localVarOptionals.BeginCreatedTime.IsSet() {
		localVarQueryParams.Add("begin_created_time", parameterToString(localVarOptionals.BeginCreatedTime.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.EndCreatedTime.IsSet() {
		localVarQueryParams.Add("end_created_time", parameterToString(localVarOptionals.EndCreatedTime.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsFormListGetResponse
