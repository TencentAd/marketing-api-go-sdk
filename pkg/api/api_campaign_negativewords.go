...
func (a *CampaignNegativewordsApiService) Add(ctx context.Context, data CampaignNegativewordsAddRequest) (CampaignNegativewordsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue CampaignNegativewordsAddResponseData
		localVarResponse    CampaignNegativewordsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/campaign_negativewords/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CampaignNegativewordsAddResponse
...
func (a *CampaignNegativewordsApiService) Get(ctx context.Context, data CampaignNegativewordsGetRequest) (CampaignNegativewordsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue CampaignNegativewordsGetResponseData
		localVarResponse    CampaignNegativewordsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/campaign_negativewords/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CampaignNegativewordsGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *CampaignNegativewordsApiService) Update(ctx context.Context, data CampaignNegativewordsUpdateRequest) (CampaignNegativewordsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue CampaignNegativewordsUpdateResponseData
		localVarResponse    CampaignNegativewordsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/campaign_negativewords/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CampaignNegativewordsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
