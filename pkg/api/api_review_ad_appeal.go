...
func (a *ReviewAdAppealApiService) Add(ctx context.Context, data ReviewAdAppealAddRequest) (interface{}, http.Header, error) {
	var (
		...
		localVarResponse    ReviewAdAppealAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/review_ad_appeal/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReviewAdAppealAddResponse
...
func (a *ReviewAdAppealApiService) Get(ctx context.Context, data ReviewAdAppealGetRequest) (ReviewAdAppealGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ReviewAdAppealGetResponseData
		localVarResponse    ReviewAdAppealGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/review_ad_appeal/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReviewAdAppealGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
