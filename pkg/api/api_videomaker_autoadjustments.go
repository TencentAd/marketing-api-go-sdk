...
/*
VideomakerAutoadjustmentsApiService 创建智能调整任务
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param adjustmentType
 * @param optional nil or *VideomakerAutoadjustmentsAddOpts - Optional Parameters:
     * @param "VideoId" (optional.String) -
     * @param "VideoFile" (optional.Interface of *os.File) -
     * @param "Signature" (optional.String) -
     * @param "SmartAdjustment" (optional.Interface of SmartAdjustment) -
     * @param "ManualAdjustment" (optional.Interface of ManualAdjustment) -
...
func (a *VideomakerAutoadjustmentsApiService) Add(ctx context.Context, accountId int64, adjustmentType string, localVarOptionals *VideomakerAutoadjustmentsAddOpts) (VideomakerAutoadjustmentsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideomakerAutoadjustmentsAddResponseData
		localVarResponse    VideomakerAutoadjustmentsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/videomaker_autoadjustments/add"
	...
	localVarFormParams.Add("adjustment_type", parameterToString(adjustmentType, ""))
	if localVarOptionals != nil && localVarOptionals.SmartAdjustment.IsSet() {
		localVarFormParams.Add("smart_adjustment", parameterToString(localVarOptionals.SmartAdjustment.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.ManualAdjustment.IsSet() {
		localVarFormParams.Add("manual_adjustment", parameterToString(localVarOptionals.ManualAdjustment.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideomakerAutoadjustmentsAddResponse
