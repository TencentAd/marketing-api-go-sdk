...
/*
GameFeatureTagsApiService 获取游戏特征标签
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param type_
 * @param optional nil or *GameFeatureTagsGetOpts - Optional Parameters:
...
func (a *GameFeatureTagsApiService) Get(ctx context.Context, accountId int64, type_ string, localVarOptionals *GameFeatureTagsGetOpts) (GameFeatureTagsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue GameFeatureTagsGetResponseData
		localVarResponse    GameFeatureTagsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/game_feature_tags/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GameFeatureTagsGetResponse
