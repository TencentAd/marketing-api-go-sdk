...
func (a *LabelsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LabelsGetOpts) (LabelsGetResponseData, *http.Response, error) {
	var (
		...
		localVarReturnValue LabelsGetResponseData
		localVarResponse    LabelsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/labels/get"
