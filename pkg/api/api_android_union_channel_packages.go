...
func (a *AndroidUnionChannelPackagesApiService) Update(ctx context.Context, data AndroidUnionChannelPackagesUpdateRequest) (AndroidUnionChannelPackagesUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AndroidUnionChannelPackagesUpdateResponseData
		localVarResponse    AndroidUnionChannelPackagesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/android_union_channel_packages/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AndroidUnionChannelPackagesUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
