...
func (a *LocalStoresAddressParsingResultApiService) Get(ctx context.Context, data LocalStoresAddressParsingResultGetRequest) (LocalStoresAddressParsingResultGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalStoresAddressParsingResultGetResponseData
		localVarResponse    LocalStoresAddressParsingResultGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores_address_parsing_result/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStoresAddressParsingResultGetResponse
