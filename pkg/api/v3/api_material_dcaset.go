...
func (a *MaterialDcasetApiService) Add(ctx context.Context, data MaterialDcasetAddRequest) (MaterialDcasetAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MaterialDcasetAddResponseData
		localVarResponse    MaterialDcasetAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/material_dcaset/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MaterialDcasetAddResponse
