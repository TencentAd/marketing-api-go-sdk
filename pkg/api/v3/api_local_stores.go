...
func (a *LocalStoresApiService) Add(ctx context.Context, data LocalStoresAddRequest) (LocalStoresAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalStoresAddResponseData
		localVarResponse    LocalStoresAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores/add"
...
func (a *LocalStoresApiService) Delete(ctx context.Context, data LocalStoresDeleteRequest) (LocalStoresDeleteResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStoresDeleteResponseData
		localVarResponse    LocalStoresDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStoresDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
/*
LocalStoresApiService 查询门店信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *LocalStoresGetOpts - Optional Parameters:
...
func (a *LocalStoresApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LocalStoresGetOpts) (LocalStoresGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStoresGetResponseData
		localVarResponse    LocalStoresGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores/get"
...
func (a *LocalStoresApiService) Update(ctx context.Context, data LocalStoresUpdateRequest) (LocalStoresUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStoresUpdateResponseData
		localVarResponse    LocalStoresUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStoresUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
