...
func (a *MergeFundTypeFundsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *MergeFundTypeFundsGetOpts) (MergeFundTypeFundsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MergeFundTypeFundsGetResponseData
		localVarResponse    MergeFundTypeFundsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/merge_fund_type_funds/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MergeFundTypeFundsGetResponse
