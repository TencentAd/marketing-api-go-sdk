...
func (a *MuseAiUgcApiService) Add(ctx context.Context, data MuseAiUgcAddRequest) (MuseAiUgcAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MuseAiUgcAddResponseData
		localVarResponse    MuseAiUgcAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/muse_ai_ugc/add"
