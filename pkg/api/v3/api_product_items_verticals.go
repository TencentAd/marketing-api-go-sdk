...
func (a *ProductItemsVerticalsApiService) Get(ctx context.Context, localVarOptionals *ProductItemsVerticalsGetOpts) (ProductItemsVerticalsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ProductItemsVerticalsGetResponseData
		localVarResponse    ProductItemsVerticalsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/product_items_verticals/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProductItemsVerticalsGetResponse
