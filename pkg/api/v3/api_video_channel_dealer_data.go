...
func (a *VideoChannelDealerDataApiService) Get(ctx context.Context, data VideoChannelDealerDataGetRequest) (VideoChannelDealerDataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideoChannelDealerDataGetResponseData
		localVarResponse    VideoChannelDealerDataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/video_channel_dealer_data/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideoChannelDealerDataGetResponse
