...
func (a *SubcustomerTransferApiService) Add(ctx context.Context, data SubcustomerTransferAddRequest) (SubcustomerTransferAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue SubcustomerTransferAddResponseData
		localVarResponse    SubcustomerTransferAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/subcustomer_transfer/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubcustomerTransferAddResponse
