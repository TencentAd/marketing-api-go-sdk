...
/*
WalletApiService 获取钱包信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *WalletGetOpts - Optional Parameters:
...
func (a *WalletApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WalletGetOpts) (WalletGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WalletGetResponseData
		localVarResponse    WalletGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wallet/get"
