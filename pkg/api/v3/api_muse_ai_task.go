...
func (a *MuseAiTaskApiService) Add(ctx context.Context, data MuseAiTaskAddRequest) (MuseAiTaskAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MuseAiTaskAddResponseData
		localVarResponse    MuseAiTaskAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/muse_ai_task/add"
...
/*
MuseAiTaskApiService 获取妙思任务结果接口
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param taskId
 * @param optional nil or *MuseAiTaskGetOpts - Optional Parameters:
...
func (a *MuseAiTaskApiService) Get(ctx context.Context, accountId int64, taskId int64, localVarOptionals *MuseAiTaskGetOpts) (MuseAiTaskGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue MuseAiTaskGetResponseData
		localVarResponse    MuseAiTaskGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/muse_ai_task/get"
