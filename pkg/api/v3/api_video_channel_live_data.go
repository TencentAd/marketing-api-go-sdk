...
func (a *VideoChannelLiveDataApiService) Get(ctx context.Context, data VideoChannelLiveDataGetRequest) (VideoChannelLiveDataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideoChannelLiveDataGetResponseData
		localVarResponse    VideoChannelLiveDataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/video_channel_live_data/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideoChannelLiveDataGetResponse
