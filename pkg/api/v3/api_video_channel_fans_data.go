...
func (a *VideoChannelFansDataApiService) Get(ctx context.Context, data VideoChannelFansDataGetRequest) (VideoChannelFansDataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideoChannelFansDataGetResponseData
		localVarResponse    VideoChannelFansDataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/video_channel_fans_data/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideoChannelFansDataGetResponse
