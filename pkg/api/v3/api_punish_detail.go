...
*/
func (a *PunishDetailApiService) Get(ctx context.Context, data PunishDetailGetRequest) (PunishDetailGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PunishDetailGetResponseData
		localVarResponse    PunishDetailGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/punish_detail/get"
