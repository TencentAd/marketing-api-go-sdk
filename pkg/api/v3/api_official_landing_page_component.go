...
type OfficialLandingPageComponentApiService service

/*
OfficialLandingPageComponentApiService 官方落地页-基于组件创建
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return OfficialLandingPageComponentAddResponse
*/
func (a *OfficialLandingPageComponentApiService) Add(ctx context.Context, data OfficialLandingPageComponentAddRequest) (OfficialLandingPageComponentAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue OfficialLandingPageComponentAddResponseData
		localVarResponse    OfficialLandingPageComponentAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/official_landing_page_component/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OfficialLandingPageComponentAddResponse
