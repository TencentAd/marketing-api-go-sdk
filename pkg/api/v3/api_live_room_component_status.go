...
func (a *LiveRoomComponentStatusApiService) Update(ctx context.Context, data LiveRoomComponentStatusUpdateRequest) (LiveRoomComponentStatusUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LiveRoomComponentStatusUpdateResponseData
		localVarResponse    LiveRoomComponentStatusUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/live_room_component_status/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LiveRoomComponentStatusUpdateResponse
