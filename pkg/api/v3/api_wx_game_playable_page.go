...
/*
WxGamePlayablePageApiService 获取微信小游戏试玩页
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param appId
 * @param optional nil or *WxGamePlayablePageGetOpts - Optional Parameters:
...
func (a *WxGamePlayablePageApiService) Get(ctx context.Context, accountId int64, appId string, localVarOptionals *WxGamePlayablePageGetOpts) (WxGamePlayablePageGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WxGamePlayablePageGetResponseData
		localVarResponse    WxGamePlayablePageGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wx_game_playable_page/get"
	...
	localVarQueryParams.Add("app_id", parameterToString(appId, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WxGamePlayablePageGetResponse
