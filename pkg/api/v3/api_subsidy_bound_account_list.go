 ...
 * @param page
 * @param pageSize
 * @param optional nil or *SubsidyBoundAccountListGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return SubsidyBoundAccountListGetResponse
*/

type SubsidyBoundAccountListGetOpts struct {
	Fields optional.Interface
}

func (a *SubsidyBoundAccountListApiService) Get(ctx context.Context, accountId int64, page int64, pageSize int64, localVarOptionals *SubsidyBoundAccountListGetOpts) (SubsidyBoundAccountListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue SubsidyBoundAccountListGetResponseData
		localVarResponse    SubsidyBoundAccountListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/subsidy_bound_account_list/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubsidyBoundAccountListGetResponse
