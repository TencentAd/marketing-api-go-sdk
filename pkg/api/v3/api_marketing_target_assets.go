...
func (a *MarketingTargetAssetsApiService) Add(ctx context.Context, data MarketingTargetAssetsAddRequest) (MarketingTargetAssetsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MarketingTargetAssetsAddResponseData
		localVarResponse    MarketingTargetAssetsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_assets/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetsAddResponse
...
func (a *MarketingTargetAssetsApiService) Delete(ctx context.Context, data MarketingTargetAssetsDeleteRequest) (interface{}, http.Header, error) {
	var (
		...
		localVarResponse    MarketingTargetAssetsDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_assets/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetsDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *MarketingTargetAssetsApiService) Get(ctx context.Context, accountId int64, marketingTargetType string, localVarOptionals *MarketingTargetAssetsGetOpts) (MarketingTargetAssetsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue MarketingTargetAssetsGetResponseData
		localVarResponse    MarketingTargetAssetsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_assets/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetsGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *MarketingTargetAssetsApiService) Update(ctx context.Context, data MarketingTargetAssetsUpdateRequest) (interface{}, http.Header, error) {
	var (
		...
		localVarFileKey     string
		localVarReturnValue interface{}
		localVarResponse    MarketingTargetAssetsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_assets/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
