...
func (a *WechatPagesCustomApiService) Add(ctx context.Context, data WechatPagesCustomAddRequest) (WechatPagesCustomAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatPagesCustomAddResponseData
		localVarResponse    WechatPagesCustomAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_pages_custom/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatPagesCustomAddResponse
