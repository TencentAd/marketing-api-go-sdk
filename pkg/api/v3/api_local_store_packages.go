...
func (a *LocalStorePackagesApiService) Add(ctx context.Context, data LocalStorePackagesAddRequest) (LocalStorePackagesAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalStorePackagesAddResponseData
		localVarResponse    LocalStorePackagesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_store_packages/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStorePackagesAddResponse
...
func (a *LocalStorePackagesApiService) Delete(ctx context.Context, data LocalStorePackagesDeleteRequest) (LocalStorePackagesDeleteResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStorePackagesDeleteResponseData
		localVarResponse    LocalStorePackagesDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_store_packages/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStorePackagesDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
/*
LocalStorePackagesApiService 查询门店包信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *LocalStorePackagesGetOpts - Optional Parameters:
...
func (a *LocalStorePackagesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LocalStorePackagesGetOpts) (LocalStorePackagesGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStorePackagesGetResponseData
		localVarResponse    LocalStorePackagesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_store_packages/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStorePackagesGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *LocalStorePackagesApiService) Update(ctx context.Context, data LocalStorePackagesUpdateRequest) (LocalStorePackagesUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalStorePackagesUpdateResponseData
		localVarResponse    LocalStorePackagesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_store_packages/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStorePackagesUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
