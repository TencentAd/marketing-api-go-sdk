...
/*
BarrageRecommendApiService 查询运营推荐弹幕列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *BarrageRecommendGetOpts - Optional Parameters:
...
func (a *BarrageRecommendApiService) Get(ctx context.Context, accountId int64, localVarOptionals *BarrageRecommendGetOpts) (BarrageRecommendGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BarrageRecommendGetResponseData
		localVarResponse    BarrageRecommendGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/barrage_recommend/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BarrageRecommendGetResponse
