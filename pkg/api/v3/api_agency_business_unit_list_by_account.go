...
/*
AgencyBusinessUnitListByAccountApiService 查询账号所属的服务商业务单元
...
func (a *AgencyBusinessUnitListByAccountApiService) Get(ctx context.Context, data AgencyBusinessUnitListByAccountGetRequest) (AgencyBusinessUnitListByAccountGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AgencyBusinessUnitListByAccountGetResponseData
		localVarResponse    AgencyBusinessUnitListByAccountGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/agency_business_unit_list_by_account/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AgencyBusinessUnitListByAccountGetResponse
