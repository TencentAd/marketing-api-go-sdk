...
/*
ChannelsUserpageobjectsApiService 获取视频号动态列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *ChannelsUserpageobjectsGetOpts - Optional Parameters:
...
func (a *ChannelsUserpageobjectsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *ChannelsUserpageobjectsGetOpts) (ChannelsUserpageobjectsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ChannelsUserpageobjectsGetResponseData
		localVarResponse    ChannelsUserpageobjectsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels_userpageobjects/get"
	...
	if localVarOptionals != nil && localVarOptionals.FinderUsername.IsSet() {
		localVarQueryParams.Add("finder_username", parameterToString(localVarOptionals.FinderUsername.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.LastBuffer.IsSet() {
		localVarQueryParams.Add("last_buffer", parameterToString(localVarOptionals.LastBuffer.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChannelsUserpageobjectsGetResponse
