...
/*
WechatStoreProductItemsApiService 获取微信小店商品
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param productCatalogId
 * @param optional nil or *WechatStoreProductItemsGetOpts - Optional Parameters:
     * @param "Filtering" (optional.Interface of []WechatStoreProductFilteringStruct) -
...
func (a *WechatStoreProductItemsApiService) Get(ctx context.Context, accountId int64, productCatalogId int64, localVarOptionals *WechatStoreProductItemsGetOpts) (WechatStoreProductItemsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatStoreProductItemsGetResponseData
		localVarResponse    WechatStoreProductItemsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_store_product_items/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatStoreProductItemsGetResponse
