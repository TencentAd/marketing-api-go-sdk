...
func (a *WechatShopAuthorizationApiService) Add(ctx context.Context, data WechatShopAuthorizationAddRequest) (WechatShopAuthorizationAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatShopAuthorizationAddResponseData
		localVarResponse    WechatShopAuthorizationAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_shop_authorization/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatShopAuthorizationAddResponse
...
/*
WechatShopAuthorizationApiService 获取微信小店授权记录列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *WechatShopAuthorizationGetOpts - Optional Parameters:
...
func (a *WechatShopAuthorizationApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WechatShopAuthorizationGetOpts) (WechatShopAuthorizationGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue WechatShopAuthorizationGetResponseData
		localVarResponse    WechatShopAuthorizationGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_shop_authorization/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatShopAuthorizationGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
