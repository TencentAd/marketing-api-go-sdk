...
func (a *ConversionLinkAssetsApiService) Add(ctx context.Context, data ConversionLinkAssetsAddRequest) (ConversionLinkAssetsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ConversionLinkAssetsAddResponseData
		localVarResponse    ConversionLinkAssetsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/conversion_link_assets/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConversionLinkAssetsAddResponse
...
/*
ConversionLinkAssetsApiService 获取营销链路
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param filtering
 * @param optional nil or *ConversionLinkAssetsGetOpts - Optional Parameters:
...
func (a *ConversionLinkAssetsApiService) Get(ctx context.Context, accountId int64, filtering []FilteringStruct, localVarOptionals *ConversionLinkAssetsGetOpts) (ConversionLinkAssetsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ConversionLinkAssetsGetResponseData
		localVarResponse    ConversionLinkAssetsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/conversion_link_assets/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConversionLinkAssetsGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *ConversionLinkAssetsApiService) Update(ctx context.Context, data ConversionLinkAssetsUpdateRequest) (ConversionLinkAssetsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ConversionLinkAssetsUpdateResponseData
		localVarResponse    ConversionLinkAssetsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/conversion_link_assets/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConversionLinkAssetsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
