...
func (a *DynamicAdVideoApiService) Add(ctx context.Context, data DynamicAdVideoAddRequest) (DynamicAdVideoAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue DynamicAdVideoAddResponseData
		localVarResponse    DynamicAdVideoAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_ad_video/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicAdVideoAddResponse
 ...
 * @param dynamicAdTemplateId
 * @param optional nil or *DynamicAdVideoGetOpts - Optional Parameters:
...
func (a *DynamicAdVideoApiService) Get(ctx context.Context, accountId int64, productCatalogId int64, productMode string, productOuterId string, dynamicAdTemplateId int64, localVarOptionals *DynamicAdVideoGetOpts) (DynamicAdVideoGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue DynamicAdVideoGetResponseData
		localVarResponse    DynamicAdVideoGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_ad_video/get"
	...
	localVarQueryParams.Add("dynamic_ad_template_id", parameterToString(dynamicAdTemplateId, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicAdVideoGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
