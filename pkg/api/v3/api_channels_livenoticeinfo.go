...
/*
ChannelsLivenoticeinfoApiService 获取视频号当前的预约直播信息
...
func (a *ChannelsLivenoticeinfoApiService) Get(ctx context.Context, accountId int64, localVarOptionals *ChannelsLivenoticeinfoGetOpts) (ChannelsLivenoticeinfoGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ChannelsLivenoticeinfoGetResponseData
		localVarResponse    ChannelsLivenoticeinfoGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels_livenoticeinfo/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChannelsLivenoticeinfoGetResponse
