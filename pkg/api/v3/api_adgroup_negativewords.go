...
/*
AdgroupNegativewordsApiService 新增否定词
...
func (a *AdgroupNegativewordsApiService) Add(ctx context.Context, data AdgroupNegativewordsAddRequest) (AdgroupNegativewordsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AdgroupNegativewordsAddResponseData
		localVarResponse    AdgroupNegativewordsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adgroup_negativewords/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdgroupNegativewordsAddResponse
...
/*
AdgroupNegativewordsApiService 查询否定词
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param adgroupIds
...
func (a *AdgroupNegativewordsApiService) Get(ctx context.Context, accountId int64, adgroupIds []int64, localVarOptionals *AdgroupNegativewordsGetOpts) (AdgroupNegativewordsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AdgroupNegativewordsGetResponseData
		localVarResponse    AdgroupNegativewordsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adgroup_negativewords/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdgroupNegativewordsGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
/*
AdgroupNegativewordsApiService 更新否定词
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data
...
func (a *AdgroupNegativewordsApiService) Update(ctx context.Context, data AdgroupNegativewordsUpdateRequest) (AdgroupNegativewordsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AdgroupNegativewordsUpdateResponseData
		localVarResponse    AdgroupNegativewordsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adgroup_negativewords/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdgroupNegativewordsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
