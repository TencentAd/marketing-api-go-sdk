...
/*
CreativeTemplatePreviewsApiService 获取创意预览
...
func (a *CreativeTemplatePreviewsApiService) Get(ctx context.Context, data CreativeTemplatePreviewsGetRequest) (CreativeTemplatePreviewsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue CreativeTemplatePreviewsGetResponseData
		localVarResponse    CreativeTemplatePreviewsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/creative_template_previews/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CreativeTemplatePreviewsGetResponse
