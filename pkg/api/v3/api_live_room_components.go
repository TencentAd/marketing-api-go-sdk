...
func (a *LiveRoomComponentsApiService) Add(ctx context.Context, data LiveRoomComponentsAddRequest) (LiveRoomComponentsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LiveRoomComponentsAddResponseData
		localVarResponse    LiveRoomComponentsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/live_room_components/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LiveRoomComponentsAddResponse
...
func (a *LiveRoomComponentsApiService) Delete(ctx context.Context, data LiveRoomComponentsDeleteRequest) (LiveRoomComponentsDeleteResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LiveRoomComponentsDeleteResponseData
		localVarResponse    LiveRoomComponentsDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/live_room_components/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LiveRoomComponentsDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
/*
LiveRoomComponentsApiService 查询直播间组件信息
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *LiveRoomComponentsGetOpts - Optional Parameters:
...
func (a *LiveRoomComponentsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LiveRoomComponentsGetOpts) (LiveRoomComponentsGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LiveRoomComponentsGetResponseData
		localVarResponse    LiveRoomComponentsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/live_room_components/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LiveRoomComponentsGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *LiveRoomComponentsApiService) Update(ctx context.Context, data LiveRoomComponentsUpdateRequest) (LiveRoomComponentsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LiveRoomComponentsUpdateResponseData
		localVarResponse    LiveRoomComponentsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/live_room_components/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LiveRoomComponentsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
