...
func (a *ProductSeriesApiService) Add(ctx context.Context, data ProductSeriesAddRequest) (ProductSeriesAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ProductSeriesAddResponseData
		localVarResponse    ProductSeriesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/product_series/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProductSeriesAddResponse
