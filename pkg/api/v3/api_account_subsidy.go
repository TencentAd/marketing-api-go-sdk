...
type AccountSubsidyApiService service

/*
AccountSubsidyApiService 获取广告主关联的补贴账号
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *AccountSubsidyGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return AccountSubsidyGetResponse
*/

type AccountSubsidyGetOpts struct {
	Fields optional.Interface
}

func (a *AccountSubsidyApiService) Get(ctx context.Context, accountId int64, localVarOptionals *AccountSubsidyGetOpts) (AccountSubsidyGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AccountSubsidyGetResponseData
		localVarResponse    AccountSubsidyGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/account_subsidy/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AccountSubsidyGetResponse
