...
func (a *WalletTransferApiService) Add(ctx context.Context, data WalletTransferAddRequest) (WalletTransferAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WalletTransferAddResponseData
		localVarResponse    WalletTransferAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wallet_transfer/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WalletTransferAddResponse
