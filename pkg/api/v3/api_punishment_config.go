...
type PunishmentConfigApiService service

/*
PunishmentConfigApiService 获取处罚系统配置
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PunishmentConfigGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return PunishmentConfigGetResponse
*/

type PunishmentConfigGetOpts struct {
	Fields optional.Interface
}

func (a *PunishmentConfigApiService) Get(ctx context.Context, localVarOptionals *PunishmentConfigGetOpts) (PunishmentConfigGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PunishmentConfigGetResponseData
		localVarResponse    PunishmentConfigGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/punishment_config/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PunishmentConfigGetResponse
