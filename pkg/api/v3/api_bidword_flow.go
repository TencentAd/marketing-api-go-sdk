 ...
 * @param accountId
 * @param bidwordList
 * @param optional nil or *BidwordFlowGetOpts - Optional Parameters:
...
func (a *BidwordFlowApiService) Get(ctx context.Context, accountId int64, bidwordList []string, localVarOptionals *BidwordFlowGetOpts) (BidwordFlowGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BidwordFlowGetResponseData
		localVarResponse    BidwordFlowGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/bidword_flow/get"
	...
	localVarQueryParams.Add("bidword_list", parameterToString(bidwordList, "multi"))
