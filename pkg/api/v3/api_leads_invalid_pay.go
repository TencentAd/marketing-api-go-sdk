 ...
 * @param accountId
 * @param month
 * @param optional nil or *LeadsInvalidPayGetOpts - Optional Parameters:
...
func (a *LeadsInvalidPayApiService) Get(ctx context.Context, accountId int64, month string, localVarOptionals *LeadsInvalidPayGetOpts) (LeadsInvalidPayGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsInvalidPayGetResponseData
		localVarResponse    LeadsInvalidPayGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_invalid_pay/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsInvalidPayGetResponse
