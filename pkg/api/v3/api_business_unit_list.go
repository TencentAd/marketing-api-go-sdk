...
type BusinessUnitListApiService service

/*
BusinessUnitListApiService 查询业务单元列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page
 * @param pageSize
 * @param optional nil or *BusinessUnitListGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return BusinessUnitListGetResponse
*/

type BusinessUnitListGetOpts struct {
	Fields optional.Interface
}

func (a *BusinessUnitListApiService) Get(ctx context.Context, page int64, pageSize int64, localVarOptionals *BusinessUnitListGetOpts) (BusinessUnitListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BusinessUnitListGetResponseData
		localVarResponse    BusinessUnitListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/business_unit_list/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BusinessUnitListGetResponse
