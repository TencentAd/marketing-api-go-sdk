...
@return SubsidyAccountBindAddResponse
*/
func (a *SubsidyAccountBindApiService) Add(ctx context.Context, data SubsidyAccountBindAddRequest) (SubsidyAccountBindAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue SubsidyAccountBindAddResponseData
		localVarResponse    SubsidyAccountBindAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/subsidy_account_bind/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SubsidyAccountBindAddResponse
