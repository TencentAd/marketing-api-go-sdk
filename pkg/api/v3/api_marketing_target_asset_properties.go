...
/*
MarketingTargetAssetPropertiesApiService 获取可用的推广内容资产属性
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param organizationId
 * @param marketingTargetType
 * @param optional nil or *MarketingTargetAssetPropertiesGetOpts - Optional Parameters:
...
func (a *MarketingTargetAssetPropertiesApiService) Get(ctx context.Context, organizationId int64, marketingTargetType string, localVarOptionals *MarketingTargetAssetPropertiesGetOpts) (MarketingTargetAssetPropertiesGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MarketingTargetAssetPropertiesGetResponseData
		localVarResponse    MarketingTargetAssetPropertiesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_asset_properties/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetPropertiesGetResponse
