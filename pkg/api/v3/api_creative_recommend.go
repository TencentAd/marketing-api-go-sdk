...
type CreativeRecommendApiService service

/*
CreativeRecommendApiService 获取创意相关建议
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return CreativeRecommendGetResponse
*/
func (a *CreativeRecommendApiService) Get(ctx context.Context, data CreativeRecommendGetRequest) (CreativeRecommendGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue CreativeRecommendGetResponseData
		localVarResponse    CreativeRecommendGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/creative_recommend/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CreativeRecommendGetResponse
