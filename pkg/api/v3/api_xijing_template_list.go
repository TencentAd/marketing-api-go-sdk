...
/*
XijingTemplateListApiService 获取蹊径落地页模板列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param pageTemplateId
 * @param optional nil or *XijingTemplateListGetOpts - Optional Parameters:
     * @param "IsInteraction" (optional.Bool) -
     * @param "IsPublic" (optional.Bool) -
     * @param "TemplateSource" (optional.String) -
...
func (a *XijingTemplateListApiService) Get(ctx context.Context, accountId int64, pageTemplateId string, localVarOptionals *XijingTemplateListGetOpts) (XijingTemplateListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue XijingTemplateListGetResponseData
		localVarResponse    XijingTemplateListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/xijing_template_list/get"
	...
	localVarQueryParams.Add("page_template_id", parameterToString(pageTemplateId, ""))
	if localVarOptionals != nil && localVarOptionals.IsInteraction.IsSet() {
		localVarQueryParams.Add("is_interaction", parameterToString(localVarOptionals.IsInteraction.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.IsPublic.IsSet() {
		localVarQueryParams.Add("is_public", parameterToString(localVarOptionals.IsPublic.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.TemplateSource.IsSet() {
		localVarQueryParams.Add("template_source", parameterToString(localVarOptionals.TemplateSource.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v XijingTemplateListGetResponse
