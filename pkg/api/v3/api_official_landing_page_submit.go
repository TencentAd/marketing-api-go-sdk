...
type OfficialLandingPageSubmitApiService service

/*
OfficialLandingPageSubmitApiService 官方落地页-送审落地页
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return OfficialLandingPageSubmitUpdateResponse
*/
func (a *OfficialLandingPageSubmitApiService) Update(ctx context.Context, data OfficialLandingPageSubmitUpdateRequest) (OfficialLandingPageSubmitUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue OfficialLandingPageSubmitUpdateResponseData
		localVarResponse    OfficialLandingPageSubmitUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/official_landing_page_submit/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OfficialLandingPageSubmitUpdateResponse
