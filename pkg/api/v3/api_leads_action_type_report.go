...
func (a *LeadsActionTypeReportApiService) Add(ctx context.Context, data LeadsActionTypeReportAddRequest) (LeadsActionTypeReportAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsActionTypeReportAddResponseData
		localVarResponse    LeadsActionTypeReportAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_action_type_report/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsActionTypeReportAddResponse
