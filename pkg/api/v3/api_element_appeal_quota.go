...
/*
ElementAppealQuotaApiService 获取元素申诉复审配额
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *ElementAppealQuotaGetOpts - Optional Parameters:
...
func (a *ElementAppealQuotaApiService) Get(ctx context.Context, accountId int64, localVarOptionals *ElementAppealQuotaGetOpts) (ElementAppealQuotaGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ElementAppealQuotaGetResponseData
		localVarResponse    ElementAppealQuotaGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/element_appeal_quota/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ElementAppealQuotaGetResponse
