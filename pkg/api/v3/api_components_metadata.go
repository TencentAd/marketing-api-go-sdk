...
/*
ComponentsMetadataApiService 查询创意组件元数据
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *ComponentsMetadataGetOpts - Optional Parameters:
     * @param "Filtering" (optional.Interface of []GetMetadataFilteringStruct) -
...
func (a *ComponentsMetadataApiService) Get(ctx context.Context, accountId int64, localVarOptionals *ComponentsMetadataGetOpts) (ComponentsMetadataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ComponentsMetadataGetResponseData
		localVarResponse    ComponentsMetadataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/components_metadata/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentsMetadataGetResponse
