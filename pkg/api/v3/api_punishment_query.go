...
type PunishmentQueryApiService service

/*
PunishmentQueryApiService 获取违规处罚列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return PunishmentQueryGetResponse
*/
func (a *PunishmentQueryApiService) Get(ctx context.Context, data PunishmentQueryGetRequest) (PunishmentQueryGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PunishmentQueryGetResponseData
		localVarResponse    PunishmentQueryGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/punishment_query/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PunishmentQueryGetResponse
