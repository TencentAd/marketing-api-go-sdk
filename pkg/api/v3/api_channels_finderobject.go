...
/*
ChannelsFinderobjectApiService 获取视频号动态详情
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param exportId
 * @param optional nil or *ChannelsFinderobjectGetOpts - Optional Parameters:
...
func (a *ChannelsFinderobjectApiService) Get(ctx context.Context, accountId int64, exportId string, localVarOptionals *ChannelsFinderobjectGetOpts) (ChannelsFinderobjectGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ChannelsFinderobjectGetResponseData
		localVarResponse    ChannelsFinderobjectGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/channels_finderobject/get"
	...
	localVarQueryParams.Add("export_id", parameterToString(exportId, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChannelsFinderobjectGetResponse
