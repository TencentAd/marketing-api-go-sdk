...
func (a *ProgrammedCommponentPreviewTemplateApiService) Update(ctx context.Context, data ProgrammedCommponentPreviewTemplateUpdateRequest) (ProgrammedCommponentPreviewTemplateUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ProgrammedCommponentPreviewTemplateUpdateResponseData
		localVarResponse    ProgrammedCommponentPreviewTemplateUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/programmed_commponent_preview_template/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProgrammedCommponentPreviewTemplateUpdateResponse
