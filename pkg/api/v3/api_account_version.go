...
func (a *AccountVersionApiService) Get(ctx context.Context, accountId int64, localVarOptionals *AccountVersionGetOpts) (AccountVersionGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AccountVersionGetResponseData
		localVarResponse    AccountVersionGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/account_version/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AccountVersionGetResponse
