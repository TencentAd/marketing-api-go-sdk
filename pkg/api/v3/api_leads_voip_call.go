...
func (a *LeadsVoipCallApiService) Add(ctx context.Context, data LeadsVoipCallAddRequest) (LeadsVoipCallAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsVoipCallAddResponseData
		localVarResponse    LeadsVoipCallAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_voip_call/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsVoipCallAddResponse
