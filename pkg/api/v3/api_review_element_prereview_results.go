...
func (a *ReviewElementPrereviewResultsApiService) Get(ctx context.Context, data ReviewElementPrereviewResultsGetRequest) (ReviewElementPrereviewResultsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ReviewElementPrereviewResultsGetResponseData
		localVarResponse    ReviewElementPrereviewResultsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/review_element_prereview_results/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReviewElementPrereviewResultsGetResponse
