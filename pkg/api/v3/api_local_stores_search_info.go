...
/*
LocalStoresSearchInfoApiService 搜索门店
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param keyWord
 * @param optional nil or *LocalStoresSearchInfoGetOpts - Optional Parameters:
...
func (a *LocalStoresSearchInfoApiService) Get(ctx context.Context, accountId int64, keyWord string, localVarOptionals *LocalStoresSearchInfoGetOpts) (LocalStoresSearchInfoGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalStoresSearchInfoGetResponseData
		localVarResponse    LocalStoresSearchInfoGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores_search_info/get"
	...
	localVarQueryParams.Add("key_word", parameterToString(keyWord, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStoresSearchInfoGetResponse
