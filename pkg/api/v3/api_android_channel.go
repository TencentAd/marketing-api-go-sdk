...
/*
AndroidChannelApiService 获取Android渠道包
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param appId
 * @param optional nil or *AndroidChannelGetOpts - Optional Parameters:
...
func (a *AndroidChannelApiService) Get(ctx context.Context, accountId int64, appId int64, localVarOptionals *AndroidChannelGetOpts) (AndroidChannelGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AndroidChannelGetResponseData
		localVarResponse    AndroidChannelGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/android_channel/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AndroidChannelGetResponse
