...
/*
ProgrammedCommponentResultApiService 组件化创意衍生成品查询接口
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param materialDeriveId
 * @param optional nil or *ProgrammedCommponentResultGetOpts - Optional Parameters:
...
func (a *ProgrammedCommponentResultApiService) Get(ctx context.Context, accountId int64, materialDeriveId int64, localVarOptionals *ProgrammedCommponentResultGetOpts) (ProgrammedCommponentResultGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ProgrammedCommponentResultGetResponseData
		localVarResponse    ProgrammedCommponentResultGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/programmed_commponent_result/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProgrammedCommponentResultGetResponse
