 ...
 * @param page
 * @param pageSize
 * @param optional nil or *AgencyBusinessUnitListAccountGetOpts - Optional Parameters:
...
func (a *AgencyBusinessUnitListAccountApiService) Get(ctx context.Context, organizationId int64, page int64, pageSize int64, localVarOptionals *AgencyBusinessUnitListAccountGetOpts) (AgencyBusinessUnitListAccountGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AgencyBusinessUnitListAccountGetResponseData
		localVarResponse    AgencyBusinessUnitListAccountGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/agency_business_unit_list_account/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AgencyBusinessUnitListAccountGetResponse
