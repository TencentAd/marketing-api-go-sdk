...
/*
LeadsVoipCallTokenApiService 获取网络电话token
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param userId
 * @param optional nil or *LeadsVoipCallTokenGetOpts - Optional Parameters:
...
func (a *LeadsVoipCallTokenApiService) Get(ctx context.Context, accountId int64, userId int64, localVarOptionals *LeadsVoipCallTokenGetOpts) (LeadsVoipCallTokenGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsVoipCallTokenGetResponseData
		localVarResponse    LeadsVoipCallTokenGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_voip_call_token/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsVoipCallTokenGetResponse
