...
func (a *RtaexpDataRoiApiService) Get(ctx context.Context, data RtaexpDataRoiGetRequest) (RtaexpDataRoiGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue RtaexpDataRoiGetResponseData
		localVarResponse    RtaexpDataRoiGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/rtaexp_data_roi/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RtaexpDataRoiGetResponse
