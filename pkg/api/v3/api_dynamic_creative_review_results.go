...
/*
DynamicCreativeReviewResultsApiService 查询动态创意审核结果
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param dynamicCreativeIdList
 * @param optional nil or *DynamicCreativeReviewResultsGetOpts - Optional Parameters:
...
func (a *DynamicCreativeReviewResultsApiService) Get(ctx context.Context, accountId int64, dynamicCreativeIdList []int64, localVarOptionals *DynamicCreativeReviewResultsGetOpts) (DynamicCreativeReviewResultsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue DynamicCreativeReviewResultsGetResponseData
		localVarResponse    DynamicCreativeReviewResultsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_creative_review_results/get"
	...
	localVarQueryParams.Add("dynamic_creative_id_list", parameterToString(dynamicCreativeIdList, "multi"))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicCreativeReviewResultsGetResponse
