...
func (a *DynamicCreativePreviewsApiService) Add(ctx context.Context, data DynamicCreativePreviewsAddRequest) (DynamicCreativePreviewsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue DynamicCreativePreviewsAddResponseData
		localVarResponse    DynamicCreativePreviewsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_creative_previews/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicCreativePreviewsAddResponse
