...
type MuseAudiosApiService service

/*
MuseAudiosApiService 获取妙思版权音频列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return MuseAudiosGetResponse
*/
func (a *MuseAudiosApiService) Get(ctx context.Context, data MuseAudiosGetRequest) (MuseAudiosGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MuseAudiosGetResponseData
		localVarResponse    MuseAudiosGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/muse_audios/get"
