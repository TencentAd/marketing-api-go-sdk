...
func (a *WechatShopAuthorizationStatusApiService) Update(ctx context.Context, data WechatShopAuthorizationStatusUpdateRequest) (WechatShopAuthorizationStatusUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatShopAuthorizationStatusUpdateResponseData
		localVarResponse    WechatShopAuthorizationStatusUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_shop_authorization_status/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatShopAuthorizationStatusUpdateResponse
