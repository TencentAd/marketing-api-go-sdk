...
/*
WechatOfficialAccountsApiService 获取公众号列表
...
func (a *WechatOfficialAccountsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WechatOfficialAccountsGetOpts) (WechatOfficialAccountsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatOfficialAccountsGetResponseData
		localVarResponse    WechatOfficialAccountsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_official_accounts/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatOfficialAccountsGetResponse
