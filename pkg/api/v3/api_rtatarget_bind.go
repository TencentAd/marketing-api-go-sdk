...
func (a *RtatargetBindApiService) Add(ctx context.Context, data RtatargetBindAddRequest) (RtatargetBindAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue RtatargetBindAddResponseData
		localVarResponse    RtatargetBindAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/rtatarget_bind/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RtatargetBindAddResponse
...
func (a *RtatargetBindApiService) Delete(ctx context.Context, data RtatargetBindDeleteRequest) (RtatargetBindDeleteResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue RtatargetBindDeleteResponseData
		localVarResponse    RtatargetBindDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/rtatarget_bind/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RtatargetBindDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *RtatargetBindApiService) Get(ctx context.Context, data RtatargetBindGetRequest) (RtatargetBindGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue RtatargetBindGetResponseData
		localVarResponse    RtatargetBindGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/rtatarget_bind/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RtatargetBindGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
