...
/*
WechatChannelsAccountsApiService 获取视频号列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *WechatChannelsAccountsGetOpts - Optional Parameters:
...
func (a *WechatChannelsAccountsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WechatChannelsAccountsGetOpts) (WechatChannelsAccountsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatChannelsAccountsGetResponseData
		localVarResponse    WechatChannelsAccountsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_channels_accounts/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatChannelsAccountsGetResponse
