...
/*
WechatChannelsAdAccountValidationApiService 视频号一键开户校验
...
func (a *WechatChannelsAdAccountValidationApiService) Get(ctx context.Context, accountId int64, localVarOptionals *WechatChannelsAdAccountValidationGetOpts) (WechatChannelsAdAccountValidationGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatChannelsAdAccountValidationGetResponseData
		localVarResponse    WechatChannelsAdAccountValidationGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_channels_ad_account_validation/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatChannelsAdAccountValidationGetResponse
