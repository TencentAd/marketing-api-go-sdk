 ...
 * @param accountId
 * @param categoryType
 * @param optional nil or *TargetingTagsUvGetOpts - Optional Parameters:
     * @param "CategoryList" (optional.Interface of []int64) -
...
func (a *TargetingTagsUvApiService) Get(ctx context.Context, accountId int64, categoryType string, localVarOptionals *TargetingTagsUvGetOpts) (TargetingTagsUvGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue TargetingTagsUvGetResponseData
		localVarResponse    TargetingTagsUvGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/targeting_tags_uv/get"
	...
	localVarQueryParams.Add("category_type", parameterToString(categoryType, ""))
	if localVarOptionals != nil && localVarOptionals.CategoryList.IsSet() {
		localVarQueryParams.Add("category_list", parameterToString(localVarOptionals.CategoryList.Value(), "multi"))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v TargetingTagsUvGetResponse
