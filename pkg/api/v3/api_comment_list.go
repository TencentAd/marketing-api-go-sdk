...
/*
CommentListApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *CommentListGetOpts - Optional Parameters:
...
func (a *CommentListApiService) Get(ctx context.Context, accountId int64, localVarOptionals *CommentListGetOpts) (CommentListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue CommentListGetResponseData
		localVarResponse    CommentListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/comment_list/get"
