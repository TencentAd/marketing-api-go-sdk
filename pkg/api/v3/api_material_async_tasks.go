...
type MaterialAsyncTasksApiService service

/*
MaterialAsyncTasksApiService 提交异步任务
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return MaterialAsyncTasksAddResponse
*/
func (a *MaterialAsyncTasksApiService) Add(ctx context.Context, data MaterialAsyncTasksAddRequest) (MaterialAsyncTasksAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MaterialAsyncTasksAddResponseData
		localVarResponse    MaterialAsyncTasksAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/material_async_tasks/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MaterialAsyncTasksAddResponse
...
/*
MaterialAsyncTasksApiService 获取异步任务
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MaterialAsyncTasksGetOpts - Optional Parameters:
     * @param "AccountId" (optional.Int64) -
     * @param "OrganizationId" (optional.Int64) -
     * @param "OwnershipType" (optional.String) -
     * @param "Filtering" (optional.Interface of []MaterialAsyncTaskFilteringStruct) -
...
type MaterialAsyncTasksGetOpts struct {
...
func (a *MaterialAsyncTasksApiService) Get(ctx context.Context, localVarOptionals *MaterialAsyncTasksGetOpts) (MaterialAsyncTasksGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue MaterialAsyncTasksGetResponseData
		localVarResponse    MaterialAsyncTasksGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/material_async_tasks/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MaterialAsyncTasksGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
