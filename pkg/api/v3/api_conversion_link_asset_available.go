...
/*
ConversionLinkAssetAvailableApiService 获取可投放链路列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param marketingGoal
 * @param marketingTargetType
 * @param optional nil or *ConversionLinkAssetAvailableGetOpts - Optional Parameters:
     * @param "MarketingAssetOuterId" (optional.String) -
...
func (a *ConversionLinkAssetAvailableApiService) Get(ctx context.Context, accountId int64, marketingGoal string, marketingTargetType string, localVarOptionals *ConversionLinkAssetAvailableGetOpts) (ConversionLinkAssetAvailableGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ConversionLinkAssetAvailableGetResponseData
		localVarResponse    ConversionLinkAssetAvailableGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/conversion_link_asset_available/get"
	...
	if localVarOptionals != nil && localVarOptionals.MarketingAssetOuterId.IsSet() {
		localVarQueryParams.Add("marketing_asset_outer_id", parameterToString(localVarOptionals.MarketingAssetOuterId.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConversionLinkAssetAvailableGetResponse
