...
/*
MarketingTargetAssetCategoriesApiService 获取可用的推广内容资产类目
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param organizationId
 * @param marketingTargetType
 * @param optional nil or *MarketingTargetAssetCategoriesGetOpts - Optional Parameters:
...
func (a *MarketingTargetAssetCategoriesApiService) Get(ctx context.Context, organizationId int64, marketingTargetType string, localVarOptionals *MarketingTargetAssetCategoriesGetOpts) (MarketingTargetAssetCategoriesGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MarketingTargetAssetCategoriesGetResponseData
		localVarResponse    MarketingTargetAssetCategoriesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_asset_categories/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetAssetCategoriesGetResponse
