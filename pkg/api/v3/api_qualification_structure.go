 ...
 * @param optional nil or *QualificationStructureGetOpts - Optional Parameters:
...
func (a *QualificationStructureApiService) Get(ctx context.Context, accountId int64, qualificationCode string, localVarOptionals *QualificationStructureGetOpts) (QualificationStructureGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue QualificationStructureGetResponseData
		localVarResponse    QualificationStructureGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/qualification_structure/get"
	...
	localVarQueryParams.Add("qualification_code", parameterToString(qualificationCode, ""))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v QualificationStructureGetResponse
