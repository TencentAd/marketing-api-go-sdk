...
/*
BatchAsyncRequestSpecificationApiService 获取批量异步请求任务详情
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param taskId
 * @param optional nil or *BatchAsyncRequestSpecificationGetOpts - Optional Parameters:
...
func (a *BatchAsyncRequestSpecificationApiService) Get(ctx context.Context, accountId int64, taskId int64, localVarOptionals *BatchAsyncRequestSpecificationGetOpts) (BatchAsyncRequestSpecificationGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BatchAsyncRequestSpecificationGetResponseData
		localVarResponse    BatchAsyncRequestSpecificationGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/batch_async_request_specification/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BatchAsyncRequestSpecificationGetResponse
