...
func (a *AgencyBusinessUnitApiService) Add(ctx context.Context, data AgencyBusinessUnitAddRequest) (AgencyBusinessUnitAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AgencyBusinessUnitAddResponseData
		localVarResponse    AgencyBusinessUnitAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/agency_business_unit/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AgencyBusinessUnitAddResponse
...
func (a *AgencyBusinessUnitApiService) Update(ctx context.Context, data AgencyBusinessUnitUpdateRequest) (AgencyBusinessUnitUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AgencyBusinessUnitUpdateResponseData
		localVarResponse    AgencyBusinessUnitUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/agency_business_unit/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AgencyBusinessUnitUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
