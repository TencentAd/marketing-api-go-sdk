...
func (a *WechatChannelsAdAccountCertificationFileApiService) Add(ctx context.Context, data WechatChannelsAdAccountCertificationFileAddRequest) (WechatChannelsAdAccountCertificationFileAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatChannelsAdAccountCertificationFileAddResponseData
		localVarResponse    WechatChannelsAdAccountCertificationFileAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_channels_ad_account_certification_file/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatChannelsAdAccountCertificationFileAddResponse
