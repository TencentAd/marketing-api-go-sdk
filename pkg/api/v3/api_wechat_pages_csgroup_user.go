...
/*
WechatPagesCsgroupUserApiService 获取企业微信组件客服列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param corpId
 * @param optional nil or *WechatPagesCsgroupUserGetOpts - Optional Parameters:
...
func (a *WechatPagesCsgroupUserApiService) Get(ctx context.Context, accountId int64, corpId string, localVarOptionals *WechatPagesCsgroupUserGetOpts) (WechatPagesCsgroupUserGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WechatPagesCsgroupUserGetResponseData
		localVarResponse    WechatPagesCsgroupUserGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_pages_csgroup_user/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WechatPagesCsgroupUserGetResponse
