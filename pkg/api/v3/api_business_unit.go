...
/*
BusinessUnitApiService 创建客户业务单元
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return BusinessUnitAddResponse
*/
func (a *BusinessUnitApiService) Add(ctx context.Context, data BusinessUnitAddRequest) (BusinessUnitAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BusinessUnitAddResponseData
		localVarResponse    BusinessUnitAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/business_unit/add"
