...
/*
ConversionLinksApiService 获取营销链路模板
...
func (a *ConversionLinksApiService) Get(ctx context.Context, accountId int64, secondCategoryType string, localVarOptionals *ConversionLinksGetOpts) (ConversionLinksGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ConversionLinksGetResponseData
		localVarResponse    ConversionLinksGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/conversion_links/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ConversionLinksGetResponse
