...
func (a *JointBudgetRulesApiService) Add(ctx context.Context, data JointBudgetRulesAddRequest) (JointBudgetRulesAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue JointBudgetRulesAddResponseData
		localVarResponse    JointBudgetRulesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/joint_budget_rules/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v JointBudgetRulesAddResponse
...
/*
JointBudgetRulesApiService 获取联合预算
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *JointBudgetRulesGetOpts - Optional Parameters:
...
func (a *JointBudgetRulesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *JointBudgetRulesGetOpts) (JointBudgetRulesGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue JointBudgetRulesGetResponseData
		localVarResponse    JointBudgetRulesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/joint_budget_rules/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v JointBudgetRulesGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
...
func (a *JointBudgetRulesApiService) Update(ctx context.Context, data JointBudgetRulesUpdateRequest) (JointBudgetRulesUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue JointBudgetRulesUpdateResponseData
		localVarResponse    JointBudgetRulesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/joint_budget_rules/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v JointBudgetRulesUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
