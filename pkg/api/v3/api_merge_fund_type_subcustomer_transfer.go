...
func (a *MergeFundTypeSubcustomerTransferApiService) Add(ctx context.Context, data MergeFundTypeSubcustomerTransferAddRequest) (MergeFundTypeSubcustomerTransferAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MergeFundTypeSubcustomerTransferAddResponseData
		localVarResponse    MergeFundTypeSubcustomerTransferAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/merge_fund_type_subcustomer_transfer/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MergeFundTypeSubcustomerTransferAddResponse
