...
func (a *MuseAiMaterialApiService) Add(ctx context.Context, data MuseAiMaterialAddRequest) (MuseAiMaterialAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MuseAiMaterialAddResponseData
		localVarResponse    MuseAiMaterialAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/muse_ai_material/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MuseAiMaterialAddResponse
