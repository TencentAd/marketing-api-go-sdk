...
func (a *LeadsClaimApiService) Update(ctx context.Context, data LeadsClaimUpdateRequest) (LeadsClaimUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsClaimUpdateResponseData
		localVarResponse    LeadsClaimUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_claim/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsClaimUpdateResponse
