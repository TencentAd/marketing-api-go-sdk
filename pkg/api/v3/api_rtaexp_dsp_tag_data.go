...
func (a *RtaexpDspTagDataApiService) Get(ctx context.Context, data RtaexpDspTagDataGetRequest) (RtaexpDspTagDataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue RtaexpDspTagDataGetResponseData
		localVarResponse    RtaexpDspTagDataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/rtaexp_dsp_tag_data/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RtaexpDspTagDataGetResponse
