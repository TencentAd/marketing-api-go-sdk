...
/*
LeadsListApiService 获取线索列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param timeRange
 * @param optional nil or *LeadsListGetOpts - Optional Parameters:
     * @param "Page" (optional.Int64) -
     * @param "PageSize" (optional.Int64) -
     * @param "LastSearchAfterValues" (optional.Interface of []string) -
...
func (a *LeadsListApiService) Get(ctx context.Context, accountId int64, timeRange TimeRange, localVarOptionals *LeadsListGetOpts) (LeadsListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsListGetResponseData
		localVarResponse    LeadsListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_list/get"
	...
	if localVarOptionals != nil && localVarOptionals.LastSearchAfterValues.IsSet() {
		localVarQueryParams.Add("last_search_after_values", parameterToString(localVarOptionals.LastSearchAfterValues.Value(), "multi"))
	}
