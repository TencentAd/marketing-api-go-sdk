...
type PunishUidMetricsApiService service

/*
PunishUidMetricsApiService 获取素材计量治理账户指标数据
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return PunishUidMetricsGetResponse
*/
func (a *PunishUidMetricsApiService) Get(ctx context.Context, data PunishUidMetricsGetRequest) (PunishUidMetricsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PunishUidMetricsGetResponseData
		localVarResponse    PunishUidMetricsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/punish_uid_metrics/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PunishUidMetricsGetResponse
