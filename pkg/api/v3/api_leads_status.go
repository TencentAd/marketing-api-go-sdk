...
func (a *LeadsStatusApiService) Update(ctx context.Context, data LeadsStatusUpdateRequest) (LeadsStatusUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsStatusUpdateResponseData
		localVarResponse    LeadsStatusUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_status/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsStatusUpdateResponse
