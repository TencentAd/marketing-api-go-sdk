...
type PunishMetricsApiService service

/*
PunishMetricsApiService 获取素材计量治理指标数据
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return PunishMetricsGetResponse
*/
func (a *PunishMetricsApiService) Get(ctx context.Context, data PunishMetricsGetRequest) (PunishMetricsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PunishMetricsGetResponseData
		localVarResponse    PunishMetricsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/punish_metrics/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PunishMetricsGetResponse
