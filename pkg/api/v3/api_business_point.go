 ...
 * @param siteSets
 * @param accountId
 * @param optional nil or *BusinessPointGetOpts - Optional Parameters:
...
func (a *BusinessPointApiService) Get(ctx context.Context, siteSets []string, accountId int64, localVarOptionals *BusinessPointGetOpts) (BusinessPointGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BusinessPointGetResponseData
		localVarResponse    BusinessPointGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/business_point/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v BusinessPointGetResponse
