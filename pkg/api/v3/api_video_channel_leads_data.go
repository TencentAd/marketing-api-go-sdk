...
func (a *VideoChannelLeadsDataApiService) Get(ctx context.Context, data VideoChannelLeadsDataGetRequest) (VideoChannelLeadsDataGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideoChannelLeadsDataGetResponseData
		localVarResponse    VideoChannelLeadsDataGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/video_channel_leads_data/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideoChannelLeadsDataGetResponse
