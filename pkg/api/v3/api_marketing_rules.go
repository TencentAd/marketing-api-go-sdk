...
/*
MarketingRulesApiService 获取营销表达组合
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *MarketingRulesGetOpts - Optional Parameters:
...
func (a *MarketingRulesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *MarketingRulesGetOpts) (MarketingRulesGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MarketingRulesGetResponseData
		localVarResponse    MarketingRulesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_rules/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingRulesGetResponse
