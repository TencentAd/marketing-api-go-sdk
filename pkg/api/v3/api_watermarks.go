...
type WatermarksApiService service

/*
WatermarksApiService 批量添加警示语
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return WatermarksAddResponse
*/
func (a *WatermarksApiService) Add(ctx context.Context, data WatermarksAddRequest) (WatermarksAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WatermarksAddResponseData
		localVarResponse    WatermarksAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/watermarks/add"
...
/*
WatermarksApiService 查询警示语添加记录
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WatermarksGetOpts - Optional Parameters:
     * @param "AccountId" (optional.Int64) -
     * @param "OrganizationId" (optional.Int64) -
     * @param "Filtering" (optional.Interface of []QueryConditionStruct) -
...
func (a *WatermarksApiService) Get(ctx context.Context, localVarOptionals *WatermarksGetOpts) (WatermarksGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue WatermarksGetResponseData
		localVarResponse    WatermarksGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/watermarks/get"
