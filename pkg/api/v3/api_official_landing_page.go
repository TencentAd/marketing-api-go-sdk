...
type OfficialLandingPageApiService service

/*
OfficialLandingPageApiService 官方落地页-删除落地页
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return OfficialLandingPageDeleteResponse
*/
func (a *OfficialLandingPageApiService) Delete(ctx context.Context, data OfficialLandingPageDeleteRequest) (OfficialLandingPageDeleteResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue OfficialLandingPageDeleteResponseData
		localVarResponse    OfficialLandingPageDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/official_landing_page/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OfficialLandingPageDeleteResponse
