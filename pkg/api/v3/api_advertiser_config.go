...
*/
func (a *AdvertiserConfigApiService) Add(ctx context.Context, data AdvertiserConfigAddRequest) (interface{}, http.Header, error) {
	var (
		...
		localVarResponse    AdvertiserConfigAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/advertiser_config/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdvertiserConfigAddResponse
...
func (a *AdvertiserConfigApiService) Get(ctx context.Context, accountId int64, fields []string, localVarOptionals *AdvertiserConfigGetOpts) (AdvertiserConfigGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AdvertiserConfigGetResponseData
		localVarResponse    AdvertiserConfigGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/advertiser_config/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdvertiserConfigGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
