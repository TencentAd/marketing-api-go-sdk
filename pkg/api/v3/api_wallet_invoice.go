...
/*
WalletInvoiceApiService 共享钱包流水相关信息查询
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param walletIdList
 * @param dateRange
 * @param optional nil or *WalletInvoiceGetOpts - Optional Parameters:
...
func (a *WalletInvoiceApiService) Get(ctx context.Context, accountId int64, walletIdList string, dateRange WalletDateRangeTransaction, localVarOptionals *WalletInvoiceGetOpts) (WalletInvoiceGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WalletInvoiceGetResponseData
		localVarResponse    WalletInvoiceGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wallet_invoice/get"
	...
	localVarQueryParams.Add("wallet_id_list", parameterToString(walletIdList, ""))
	if localVarOptionals != nil && localVarOptionals.FundType.IsSet() {
		localVarQueryParams.Add("fund_type", parameterToString(localVarOptionals.FundType.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v WalletInvoiceGetResponse
