...
/*
ProgrammedMaterialMappingsApiService 获取衍生素材映射关系接口
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param dynamicCreativeId
 * @param optional nil or *ProgrammedMaterialMappingsGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return ProgrammedMaterialMappingsGetResponse
*/
...
func (a *ProgrammedMaterialMappingsApiService) Get(ctx context.Context, accountId int64, dynamicCreativeId int64, localVarOptionals *ProgrammedMaterialMappingsGetOpts) (ProgrammedMaterialMappingsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ProgrammedMaterialMappingsGetResponseData
		localVarResponse    ProgrammedMaterialMappingsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/programmed_material_mappings/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProgrammedMaterialMappingsGetResponse
