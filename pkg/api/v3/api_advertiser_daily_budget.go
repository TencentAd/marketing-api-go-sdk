...
func (a *AdvertiserDailyBudgetApiService) Get(ctx context.Context, accountId int64, fields []string) (AdvertiserDailyBudgetGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AdvertiserDailyBudgetGetResponseData
		localVarResponse    AdvertiserDailyBudgetGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/advertiser_daily_budget/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdvertiserDailyBudgetGetResponse
...
*/
func (a *AdvertiserDailyBudgetApiService) Update(ctx context.Context, data AdvertiserDailyBudgetUpdateRequest) (AdvertiserDailyBudgetUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AdvertiserDailyBudgetUpdateResponseData
		localVarResponse    AdvertiserDailyBudgetUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/advertiser_daily_budget/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdvertiserDailyBudgetUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
