...
/*
XijingComplexTemplateApiService 获取蹊径落地页互动模板配置
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param pageTemplateId
 * @param optional nil or *XijingComplexTemplateGetOpts - Optional Parameters:
...
func (a *XijingComplexTemplateApiService) Get(ctx context.Context, accountId int64, pageTemplateId string, localVarOptionals *XijingComplexTemplateGetOpts) (XijingComplexTemplateGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue XijingComplexTemplateGetResponseData
		localVarResponse    XijingComplexTemplateGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/xijing_complex_template/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v XijingComplexTemplateGetResponse
