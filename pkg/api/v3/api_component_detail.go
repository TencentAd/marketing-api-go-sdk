...
type ComponentDetailApiService service

/*
ComponentDetailApiService 获取创意组件详情
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ComponentDetailGetOpts - Optional Parameters:
     * @param "AccountId" (optional.Int64) -
     * @param "Filtering" (optional.Interface of []ComponentDetailFilteringStruct) -
...
type ComponentDetailGetOpts struct {
...
func (a *ComponentDetailApiService) Get(ctx context.Context, localVarOptionals *ComponentDetailGetOpts) (ComponentDetailGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ComponentDetailGetResponseData
		localVarResponse    ComponentDetailGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/component_detail/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentDetailGetResponse
