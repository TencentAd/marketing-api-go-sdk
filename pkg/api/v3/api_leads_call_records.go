 ...
 * @param startDate
 * @param endDate
 * @param optional nil or *LeadsCallRecordsGetOpts - Optional Parameters:
     * @param "SearchAfter" (optional.String) -
...
func (a *LeadsCallRecordsApiService) Get(ctx context.Context, accountId int64, pageSize int64, page int64, startDate string, endDate string, localVarOptionals *LeadsCallRecordsGetOpts) (LeadsCallRecordsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LeadsCallRecordsGetResponseData
		localVarResponse    LeadsCallRecordsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/leads_call_records/get"
	...
	if localVarOptionals != nil && localVarOptionals.SearchAfter.IsSet() {
		localVarQueryParams.Add("search_after", parameterToString(localVarOptionals.SearchAfter.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LeadsCallRecordsGetResponse
