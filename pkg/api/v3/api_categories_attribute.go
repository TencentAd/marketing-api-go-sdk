...
/*
CategoriesAttributeApiService 获取商品属性
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param verticalId
 * @param page
 * @param pageSize
 * @param optional nil or *CategoriesAttributeGetOpts - Optional Parameters:
     * @param "LastCategoryIdList" (optional.Interface of []int64) -
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return CategoriesAttributeGetResponse
*/
...
func (a *CategoriesAttributeApiService) Get(ctx context.Context, verticalId int64, page int64, pageSize int64, localVarOptionals *CategoriesAttributeGetOpts) (CategoriesAttributeGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue CategoriesAttributeGetResponseData
		localVarResponse    CategoriesAttributeGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/categories_attribute/get"
	...
	if localVarOptionals != nil && localVarOptionals.LastCategoryIdList.IsSet() {
		localVarQueryParams.Add("last_category_id_list", parameterToString(localVarOptionals.LastCategoryIdList.Value(), "multi"))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CategoriesAttributeGetResponse
