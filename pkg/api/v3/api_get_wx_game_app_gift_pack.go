...
func (a *GetWxGameAppGiftPackApiService) Get(ctx context.Context, data GetWxGameAppGiftPackGetRequest) (GetWxGameAppGiftPackGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue GetWxGameAppGiftPackGetResponseData
		localVarResponse    GetWxGameAppGiftPackGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/get_wx_game_app_gift_pack/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GetWxGameAppGiftPackGetResponse
