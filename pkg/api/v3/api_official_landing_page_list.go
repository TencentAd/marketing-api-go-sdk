...
type OfficialLandingPageListApiService service

/*
OfficialLandingPageListApiService 官方落地页-获取落地页列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *OfficialLandingPageListGetOpts - Optional Parameters:
...
type OfficialLandingPageListGetOpts struct {
	Page      optional.Int64
...
func (a *OfficialLandingPageListApiService) Get(ctx context.Context, accountId int64, localVarOptionals *OfficialLandingPageListGetOpts) (OfficialLandingPageListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue OfficialLandingPageListGetResponseData
		localVarResponse    OfficialLandingPageListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/official_landing_page_list/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v OfficialLandingPageListGetResponse
