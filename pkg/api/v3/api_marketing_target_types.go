...
func (a *MarketingTargetTypesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *MarketingTargetTypesGetOpts) (MarketingTargetTypesGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue MarketingTargetTypesGetResponseData
		localVarResponse    MarketingTargetTypesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/marketing_target_types/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MarketingTargetTypesGetResponse
