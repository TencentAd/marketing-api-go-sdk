...
/*
ComponentReviewResultsApiService 查询组件审核结果
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param componentIdList
 * @param optional nil or *ComponentReviewResultsGetOpts - Optional Parameters:
...
func (a *ComponentReviewResultsApiService) Get(ctx context.Context, accountId int64, componentIdList []int64, localVarOptionals *ComponentReviewResultsGetOpts) (ComponentReviewResultsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ComponentReviewResultsGetResponseData
		localVarResponse    ComponentReviewResultsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/component_review_results/get"
	...
	localVarQueryParams.Add("component_id_list", parameterToString(componentIdList, "multi"))
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ComponentReviewResultsGetResponse
