...
/*
FinderAdObjectListApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *FinderAdObjectListGetOpts - Optional Parameters:
...
func (a *FinderAdObjectListApiService) Get(ctx context.Context, accountId int64, localVarOptionals *FinderAdObjectListGetOpts) (FinderAdObjectListGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue FinderAdObjectListGetResponseData
		localVarResponse    FinderAdObjectListGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/finder_ad_object_list/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FinderAdObjectListGetResponse
