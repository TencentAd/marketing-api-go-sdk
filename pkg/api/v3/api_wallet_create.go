...
type WalletCreateApiService service

/*
WalletCreateApiService 新建共享钱包
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return WalletCreateAddResponse
*/
func (a *WalletCreateApiService) Add(ctx context.Context, data WalletCreateAddRequest) (WalletCreateAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue WalletCreateAddResponseData
		localVarResponse    WalletCreateAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wallet_create/add"
