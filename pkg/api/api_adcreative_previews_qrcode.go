 ...
 * @param accountId
 * @param adgroupId
 * @param optional nil or *AdcreativePreviewsQrcodeGetOpts - Optional Parameters:
...
func (a *AdcreativePreviewsQrcodeApiService) Get(ctx context.Context, accountId int64, adgroupId int64, localVarOptionals *AdcreativePreviewsQrcodeGetOpts) (AdcreativePreviewsQrcodeGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AdcreativePreviewsQrcodeGetResponseData
		localVarResponse    AdcreativePreviewsQrcodeGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adcreative_previews_qrcode/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdcreativePreviewsQrcodeGetResponse
