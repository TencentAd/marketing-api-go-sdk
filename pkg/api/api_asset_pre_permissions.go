...
/*
AssetPrePermissionsApiService 获取待确认接收授权列表接口
...
func (a *AssetPrePermissionsApiService) Get(ctx context.Context, accountId int64, assetType string, localVarOptionals *AssetPrePermissionsGetOpts) (AssetPrePermissionsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AssetPrePermissionsGetResponseData
		localVarResponse    AssetPrePermissionsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/asset_pre_permissions/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AssetPrePermissionsGetResponse
...
func (a *AssetPrePermissionsApiService) Update(ctx context.Context, data AssetPrePermissionsUpdateRequest) (interface{}, http.Header, error) {
	var (
		...
		localVarResponse    AssetPrePermissionsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/asset_pre_permissions/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AssetPrePermissionsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
