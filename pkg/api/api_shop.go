...
*/
func (a *ShopApiService) Delete(ctx context.Context, data ShopDeleteRequest) (ShopDeleteResponseData, http.Header, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue ShopDeleteResponseData
		localVarResponse    ShopDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/shop/delete"
