...
func (a *PromotedObjectAuthorizationApiService) Add(ctx context.Context, data PromotedObjectAuthorizationAddRequest) (PromotedObjectAuthorizationAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PromotedObjectAuthorizationAddResponseData
		localVarResponse    PromotedObjectAuthorizationAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/promoted_object_authorization/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PromotedObjectAuthorizationAddResponse
...
/*
PromotedObjectAuthorizationApiService 获取授权历史记录
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param promotedObjectType
 * @param optional nil or *PromotedObjectAuthorizationGetOpts - Optional Parameters:
     * @param "PromotedObjectName" (optional.String) -
...
func (a *PromotedObjectAuthorizationApiService) Get(ctx context.Context, accountId int64, promotedObjectType string, localVarOptionals *PromotedObjectAuthorizationGetOpts) (PromotedObjectAuthorizationGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue PromotedObjectAuthorizationGetResponseData
		localVarResponse    PromotedObjectAuthorizationGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/promoted_object_authorization/get"
	...
	if localVarOptionals != nil && localVarOptionals.PromotedObjectName.IsSet() {
		localVarQueryParams.Add("promoted_object_name", parameterToString(localVarOptionals.PromotedObjectName.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PromotedObjectAuthorizationGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
