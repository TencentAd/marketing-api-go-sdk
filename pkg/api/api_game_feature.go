...
func (a *GameFeatureApiService) Add(ctx context.Context, data GameFeatureAddRequest) (GameFeatureAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue GameFeatureAddResponseData
		localVarResponse    GameFeatureAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/game_feature/add"
 ...
 * @param promotedObjectId
 * @param optional nil or *GameFeatureGetOpts - Optional Parameters:
...
func (a *GameFeatureApiService) Get(ctx context.Context, accountId int64, promotedObjectType string, promotedObjectId string, localVarOptionals *GameFeatureGetOpts) (GameFeatureGetResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue GameFeatureGetResponseData
		localVarResponse    GameFeatureGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/game_feature/get"
	...
	localVarQueryParams.Add("promoted_object_id", parameterToString(promotedObjectId, ""))
...
func (a *GameFeatureApiService) Update(ctx context.Context, data GameFeatureUpdateRequest) (GameFeatureUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue GameFeatureUpdateResponseData
		localVarResponse    GameFeatureUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/game_feature/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GameFeatureUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
