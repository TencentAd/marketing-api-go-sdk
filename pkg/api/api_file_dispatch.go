...
type FileDispatchApiService service

/*
FileDispatchApiService 更新文件分发关系
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return FileDispatchUpdateResponse
*/
func (a *FileDispatchApiService) Update(ctx context.Context, data FileDispatchUpdateRequest) (FileDispatchUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue FileDispatchUpdateResponseData
		localVarResponse    FileDispatchUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/file_dispatch/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FileDispatchUpdateResponse
