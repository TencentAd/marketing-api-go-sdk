...
func (a *UnionPositionPackagesApiService) Update(ctx context.Context, data UnionPositionPackagesUpdateRequest) (UnionPositionPackagesUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue UnionPositionPackagesUpdateResponseData
		localVarResponse    UnionPositionPackagesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/union_position_packages/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UnionPositionPackagesUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
