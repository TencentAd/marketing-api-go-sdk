...
/*
CustomFeaturesApiService 获取自定义特征
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *CustomFeaturesGetOpts - Optional Parameters:
...
func (a *CustomFeaturesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *CustomFeaturesGetOpts) (CustomFeaturesGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue CustomFeaturesGetResponseData
		localVarResponse    CustomFeaturesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/custom_features/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v CustomFeaturesGetResponse
