...
/*
DiagnosisApiService 广告诊断分析工具
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param adgroupIdList
 * @param optional nil or *DiagnosisGetOpts - Optional Parameters:
...
func (a *DiagnosisApiService) Get(ctx context.Context, accountId int64, adgroupIdList []int64, localVarOptionals *DiagnosisGetOpts) (DiagnosisGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DiagnosisGetResponseData
		localVarResponse    DiagnosisGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/diagnosis/get"
