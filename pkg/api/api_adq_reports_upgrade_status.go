...
/*
AdqReportsUpgradeStatusApiService 获取腾讯广告平台广告账户升级状态
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *AdqReportsUpgradeStatusGetOpts - Optional Parameters:
     * @param "Fields" (optional.Interface of []string) -  返回参数的字段列表

@return AdqReportsUpgradeStatusGetResponse
*/
...
func (a *AdqReportsUpgradeStatusApiService) Get(ctx context.Context, accountId int64, localVarOptionals *AdqReportsUpgradeStatusGetOpts) (AdqReportsUpgradeStatusGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AdqReportsUpgradeStatusGetResponseData
		localVarResponse    AdqReportsUpgradeStatusGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adq_reports_upgrade_status/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdqReportsUpgradeStatusGetResponse
