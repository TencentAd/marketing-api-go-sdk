...
func (a *PropertyFileSessionsApiService) Add(ctx context.Context, data PropertyFileSessionsAddRequest) (PropertyFileSessionsAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue PropertyFileSessionsAddResponseData
		localVarResponse    PropertyFileSessionsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/property_file_sessions/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PropertyFileSessionsAddResponse
...
func (a *PropertyFileSessionsApiService) Update(ctx context.Context, data PropertyFileSessionsUpdateRequest) (PropertyFileSessionsUpdateResponseData, http.Header, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue PropertyFileSessionsUpdateResponseData
		localVarResponse    PropertyFileSessionsUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/property_file_sessions/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PropertyFileSessionsUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse.Header, newErr
