...
type ReviewUrgeCreativesApiService service

/*
ReviewUrgeCreativesApiService 催审创意
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return ReviewUrgeCreativesAddResponse
*/
func (a *ReviewUrgeCreativesApiService) Add(ctx context.Context, data ReviewUrgeCreativesAddRequest) (ReviewUrgeCreativesAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue ReviewUrgeCreativesAddResponseData
		localVarResponse    ReviewUrgeCreativesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/review_urge_creatives/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReviewUrgeCreativesAddResponse
