...
/*
PagesApiService 获取落地页列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param promotedObjectType
 * @param optional nil or *PagesGetOpts - Optional Parameters:
...
func (a *PagesApiService) Get(ctx context.Context, accountId int64, promotedObjectType string, localVarOptionals *PagesGetOpts) (PagesGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PagesGetResponseData
		localVarResponse    PagesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/pages/get"
