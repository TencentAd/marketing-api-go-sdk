...
func (a *AdAppealQuotaApiService) Get(ctx context.Context, data AdAppealQuotaGetRequest) (AdAppealQuotaGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AdAppealQuotaGetResponseData
		localVarResponse    AdAppealQuotaGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/ad_appeal_quota/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdAppealQuotaGetResponse
