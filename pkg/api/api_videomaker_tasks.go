...
/*
VideomakerTasksApiService 视频工具任务查询
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param taskId
 * @param optional nil or *VideomakerTasksGetOpts - Optional Parameters:
...
func (a *VideomakerTasksApiService) Get(ctx context.Context, accountId int64, taskId string, localVarOptionals *VideomakerTasksGetOpts) (VideomakerTasksGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue VideomakerTasksGetResponseData
		localVarResponse    VideomakerTasksGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/videomaker_tasks/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VideomakerTasksGetResponse
