...
/*
AppAndroidChannelPackagesApiService 获取Android渠道包
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param promotedObjectId
 * @param promotedObjectType
 * @param optional nil or *AppAndroidChannelPackagesGetOpts - Optional Parameters:
...
func (a *AppAndroidChannelPackagesApiService) Get(ctx context.Context, accountId int64, promotedObjectId string, promotedObjectType string, localVarOptionals *AppAndroidChannelPackagesGetOpts) (AppAndroidChannelPackagesGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AppAndroidChannelPackagesGetResponseData
		localVarResponse    AppAndroidChannelPackagesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/app_android_channel_packages/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AppAndroidChannelPackagesGetResponse
