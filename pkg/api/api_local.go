...
/*
LocalApiService 删除广告
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param data

@return LocalDeleteResponse
*/
func (a *LocalApiService) Delete(ctx context.Context, data LocalDeleteRequest) (LocalDeleteResponseData, http.Header, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue LocalDeleteResponseData
		localVarResponse    LocalDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local/delete"
