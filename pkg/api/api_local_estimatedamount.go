...
func (a *LocalEstimatedamountApiService) Get(ctx context.Context, data LocalEstimatedamountGetRequest) (LocalEstimatedamountGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalEstimatedamountGetResponseData
		localVarResponse    LocalEstimatedamountGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_estimatedamount/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalEstimatedamountGetResponse
