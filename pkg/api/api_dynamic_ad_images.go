...
*/
func (a *DynamicAdImagesApiService) Add(ctx context.Context, data DynamicAdImagesAddRequest) (DynamicAdImagesAddResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DynamicAdImagesAddResponseData
		localVarResponse    DynamicAdImagesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_ad_images/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicAdImagesAddResponse
...
func (a *DynamicAdImagesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *DynamicAdImagesGetOpts) (DynamicAdImagesGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DynamicAdImagesGetResponseData
		localVarResponse    DynamicAdImagesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/dynamic_ad_images/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DynamicAdImagesGetResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
