...
*/
func (a *AdcreativesApiService) Add(ctx context.Context, data AdcreativesAddRequest) (AdcreativesAddResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdcreativesAddResponseData
		localVarResponse    AdcreativesAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adcreatives/add"
...
*/
func (a *AdcreativesApiService) Delete(ctx context.Context, data AdcreativesDeleteRequest) (AdcreativesDeleteResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdcreativesDeleteResponseData
		localVarResponse    AdcreativesDeleteResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adcreatives/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdcreativesDeleteResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
AdcreativesApiService 获取广告创意
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *AdcreativesGetOpts - Optional Parameters:
...
func (a *AdcreativesApiService) Get(ctx context.Context, accountId int64, localVarOptionals *AdcreativesGetOpts) (AdcreativesGetResponseData, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdcreativesGetResponseData
		localVarResponse    AdcreativesGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adcreatives/get"
...
*/
func (a *AdcreativesApiService) Update(ctx context.Context, data AdcreativesUpdateRequest) (AdcreativesUpdateResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdcreativesUpdateResponseData
		localVarResponse    AdcreativesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/adcreatives/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdcreativesUpdateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
