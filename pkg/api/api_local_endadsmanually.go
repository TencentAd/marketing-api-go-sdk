...
func (a *LocalEndadsmanuallyApiService) Add(ctx context.Context, data LocalEndadsmanuallyAddRequest) (LocalEndadsmanuallyAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalEndadsmanuallyAddResponseData
		localVarResponse    LocalEndadsmanuallyAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_endadsmanually/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalEndadsmanuallyAddResponse
