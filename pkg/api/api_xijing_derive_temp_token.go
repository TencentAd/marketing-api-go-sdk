...
func (a *XijingDeriveTempTokenApiService) Get(ctx context.Context, data XijingDeriveTempTokenGetRequest) (XijingDeriveTempTokenGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue XijingDeriveTempTokenGetResponseData
		localVarResponse    XijingDeriveTempTokenGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/xijing_derive_temp_token/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v XijingDeriveTempTokenGetResponse
