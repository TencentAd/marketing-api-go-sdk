...
*/
func (a *UserActionsApiService) Add(ctx context.Context, data UserActionsAddRequest) (interface{}, *http.Response, error) {
	var (
		...
		localVarResponse    UserActionsAddResponse
	)
