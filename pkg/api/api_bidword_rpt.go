...
func (a *BidwordRptApiService) Get(ctx context.Context, data BidwordRptGetRequest) (BidwordRptGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue BidwordRptGetResponseData
		localVarResponse    BidwordRptGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/bidword_rpt/get"
