...
/*
LocalStoresWxpayMerchantsApiService 查询微信支付商户号
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *LocalStoresWxpayMerchantsGetOpts - Optional Parameters:
...
func (a *LocalStoresWxpayMerchantsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *LocalStoresWxpayMerchantsGetOpts) (LocalStoresWxpayMerchantsGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue LocalStoresWxpayMerchantsGetResponseData
		localVarResponse    LocalStoresWxpayMerchantsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/local_stores_wxpay_merchants/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LocalStoresWxpayMerchantsGetResponse
