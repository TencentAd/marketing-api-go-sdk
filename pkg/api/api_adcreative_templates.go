...
func (a *AdcreativeTemplatesApiService) Get(ctx context.Context, localVarOptionals *AdcreativeTemplatesGetOpts) (AdcreativeTemplatesGetResponseData, *http.Response, error) {
	var (
