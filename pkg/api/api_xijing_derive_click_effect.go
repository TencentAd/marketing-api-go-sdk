...
func (a *XijingDeriveClickEffectApiService) Get(ctx context.Context, data XijingDeriveClickEffectGetRequest) (XijingDeriveClickEffectGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue XijingDeriveClickEffectGetResponseData
		localVarResponse    XijingDeriveClickEffectGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/xijing_derive_click_effect/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v XijingDeriveClickEffectGetResponse
