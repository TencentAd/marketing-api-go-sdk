...
func (a *XijingDeriveRoleApiService) Get(ctx context.Context, data XijingDeriveRoleGetRequest) (XijingDeriveRoleGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue XijingDeriveRoleGetResponseData
		localVarResponse    XijingDeriveRoleGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/xijing_derive_role/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v XijingDeriveRoleGetResponse
