...
type WechatLeadsApiService service

/*
WechatLeadsApiService 获取销售线索(待废弃)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WechatLeadsGetOpts - Optional Parameters:
     * @param "DateRange" (optional.Interface of DateRange) -
     * @param "TimeRange" (optional.Interface of TimeRange) -
...
type WechatLeadsGetOpts struct {
	DateRange optional.Interface
...
func (a *WechatLeadsApiService) Get(ctx context.Context, localVarOptionals *WechatLeadsGetOpts) (WechatLeadsGetResponseData, *http.Response, error) {
	var (
		...
		localVarReturnValue WechatLeadsGetResponseData
		localVarResponse    WechatLeadsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/wechat_leads/get"
