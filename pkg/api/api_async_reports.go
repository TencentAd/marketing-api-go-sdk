...
*/
func (a *AsyncReportsApiService) Add(ctx context.Context, data AsyncReportsAddRequest) (AsyncReportsAddResponseData, *http.Response, error) {
	var (
		...
		localVarReturnValue AsyncReportsAddResponseData
		localVarResponse    AsyncReportsAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/async_reports/add"
...
func (a *AsyncReportsApiService) Get(ctx context.Context, accountId int64, localVarOptionals *AsyncReportsGetOpts) (AsyncReportsGetResponseData, *http.Response, error) {
	var (
		...
		localVarFileBytes   []byte
		localVarFileKey     string
		localVarReturnValue AsyncReportsGetResponseData
		localVarResponse    AsyncReportsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/async_reports/get"
