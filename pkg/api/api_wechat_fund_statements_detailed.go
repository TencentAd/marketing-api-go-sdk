...
func (a *WechatFundStatementsDetailedApiService) Get(ctx context.Context, tradeType string, dateRange DateRange, localVarOptionals *WechatFundStatementsDetailedGetOpts) (WechatFundStatementsDetailedGetResponseData, *http.Response, error) {
	var (
