...
func (a *AgencyPeerTransferApiService) Add(ctx context.Context, data AgencyPeerTransferAddRequest) (AgencyPeerTransferAddResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AgencyPeerTransferAddResponseData
		localVarResponse    AgencyPeerTransferAddResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/agency_peer_transfer/add"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AgencyPeerTransferAddResponse
