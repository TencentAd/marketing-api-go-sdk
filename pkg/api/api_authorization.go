...
func (a *AuthorizationApiService) WechatBind(ctx context.Context, accessToken string, redirectUri string, localVarOptionals *AuthorizationWechatBindOpts) (string, *http.Response, error) {
	var (
