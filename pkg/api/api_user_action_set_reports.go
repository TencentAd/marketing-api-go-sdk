...
/*
UserActionSetReportsApiService 获取用户行为数据源报表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param userActionSetId
 * @param dateRange
 * @param timeGranularity
 * @param optional nil or *UserActionSetReportsGetOpts - Optional Parameters:
...
func (a *UserActionSetReportsApiService) Get(ctx context.Context, accountId int64, userActionSetId int64, dateRange DateRange, timeGranularity string, localVarOptionals *UserActionSetReportsGetOpts) (UserActionSetReportsGetResponseData, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue UserActionSetReportsGetResponseData
		localVarResponse    UserActionSetReportsGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/user_action_set_reports/get"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UserActionSetReportsGetResponse
