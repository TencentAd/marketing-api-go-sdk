...
/*
TargetcpaTagApiService 获取分人群出价标签
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param tagTypes
 * @param optional nil or *TargetcpaTagGetOpts - Optional Parameters:
...
func (a *TargetcpaTagApiService) Get(ctx context.Context, accountId int64, tagTypes []string, localVarOptionals *TargetcpaTagGetOpts) (TargetcpaTagGetResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue TargetcpaTagGetResponseData
		localVarResponse    TargetcpaTagGetResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/targetcpa_tag/get"
	...
	localVarQueryParams.Add("tag_types", parameterToString(tagTypes, "multi"))
