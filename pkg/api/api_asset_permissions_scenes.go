...
func (a *AssetPermissionsScenesApiService) Update(ctx context.Context, data AssetPermissionsScenesUpdateRequest) (AssetPermissionsScenesUpdateResponseData, http.Header, error) {
	var (
		...
		localVarReturnValue AssetPermissionsScenesUpdateResponseData
		localVarResponse    AssetPermissionsScenesUpdateResponse
	)

	// create path and map variables
	localVarPath := a.client.Cfg.BasePath + "/asset_permissions_scenes/update"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AssetPermissionsScenesUpdateResponse
